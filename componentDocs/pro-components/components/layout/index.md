...
- 支持拖动的高级帮助[外部示例代码]
	- description: 
	- src: /layout/draggableHelp.tsx
	- thumbnail: 

- 浮层高级帮助[外部示例代码]
	- description: 
	- src: /layout/proHelpModal.tsx
	- thumbnail: 

- 远程加载帮助[外部示例代码]
	- description: 
	- src: /layout/async-load-help.tsx
	- thumbnail: 

- 通过 token 修改样式[外部示例代码]
	- description: 
...
- 侧栏导航 中后台产品默认推荐[外部示例代码]
	- description: 
	- src: /layout/siderMode.tsx
	- thumbnail: 

- 混合导航[外部示例代码]
	- description: 
	- src: /layout/mixMode.tsx
	- thumbnail: 

- 顶部导航[外部示例代码]
	- description: 
	- src: /layout/topMode.tsx
	- thumbnail: 

- 侧栏导航宽度256px[外部示例代码]
	- description: 
	- src: /layout/designSiderMenu.tsx
	- thumbnail: 

- 页脚工具栏和全局公告[外部示例代码]
	- description: 
	- src: /layout/footer-global-tools.tsx
	- thumbnail: 

-  收起时展示 title[外部示例代码]
	- description: 
	- src: /layout/collapsedShowTitle.tsx
	- thumbnail: 

- 不分组菜单样式[外部示例代码]
	- description: 
	- src: /layout/menu-group.tsx
	- thumbnail: 

- 经典导航样式[外部示例代码]
	- description: 
	- src: /layout/classicMode.tsx
	- thumbnail: 

- 通过调整页面背景内容调整整体氛围[外部示例代码]
	- description: 
	- src: /layout/background-context.tsx
	- thumbnail: 

- 定制菜单样式[外部示例代码]
	- description: 
	- src: /layout/designMenuCss.tsx
	- thumbnail: 

- 通过设置页背景和卡片样式简化界面层次[外部示例代码]
	- description: 
	- src: /layout/pageSimplify.tsx
	- thumbnail: 

- 自定侧栏菜单下方区域[外部示例代码]
	- description: 
	- src: /layout/customSider.tsx
	- thumbnail: 

- 菜单展开-站点地图[外部示例代码]
	- description: 
	- src: /layout/siteMenu.tsx
	- thumbnail: 
...
- 搜索菜单[外部示例代码]
	- description: 
	- src: /layout/searchMenu.tsx
	- thumbnail: 

- 多个路由对应一个菜单项[外部示例代码]
	- description: 
	- src: /layout/MultipleMenuOnePath.tsx
	- thumbnail: 
...
- [外部示例代码]
	- description: 
	- src: /layout/DefaultOpenAllMenu.tsx
	- thumbnail: 
...
- [外部示例代码]
	- description: 
	- src: /layout/AlwaysDefaultOpenAllMenu.tsx
	- thumbnail: 

- 使用 IconFont[外部示例代码]
	- description: 
	- src: /layout/IconFont.tsx
	- thumbnail: 
...
- ghost 模式[外部示例代码]
	- description: 
	- src: /layout/ghost.tsx
	- thumbnail: 

- 嵌套布局[外部示例代码]
	- description: 
	- src: /layout/Nested.tsx
	- thumbnail: 

- 自定义的 collapse[外部示例代码]
	- description: 
	- src: /layout/customize-collapsed.tsx
	- thumbnail: 

- 面包屑显示在顶部[外部示例代码]
	- description: 
	- src: /layout/top-breadcrumb.tsx
	- thumbnail: 

- 多级站点导航[外部示例代码]
	- description: 
	- src: /layout/immersive-navigation.tsx
	- thumbnail: 

- 沉浸式导航[外部示例代码]
	- description: 
	- src: /layout/immersive-navigation-top.tsx
	- thumbnail: 
...
- 跨站点导航列表 分组模式[外部示例代码]
	- description: 
	- src: /layout/appList-group.tsx
	- thumbnail: 

- layout 自带了错误处理功能，防止白屏[外部示例代码]
	- description: 
	- src: /layout/error-boundaries.tsx
	- thumbnail: 

- splitMenus[外部示例代码]
	- description: 
	- src: /layout/splitMenus.tsx
	- thumbnail: 
